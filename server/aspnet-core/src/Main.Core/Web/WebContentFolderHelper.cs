...
namespace Main.Web
{
    ...
    public static class WebContentDirectoryFinder
    {
        ...
        {
            var coreAssemblyDirectoryPath = Path.GetDirectoryName(typeof(MainCoreModule).GetAssembly().Location);
            if (coreAssemblyDirectoryPath == null)
            {
                throw new Exception("Could not find location of Main.Core assembly!");
            }
